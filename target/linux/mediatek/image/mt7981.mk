...
define Device/hnxt_c101
  DEVICE_VENDOR := HNXT
  DEVICE_MODEL := C101
  DEVICE_DTS := mt7981-hnxt-c101
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := hnxt,c101
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 114816k
...
define Device/comfast_cf-wr632ax
  ...
  DEVICE_PACKAGES := $(MT7981_USB_PKGS) kmod-hwmon-pwmfan fancontrol luci-app-fancontrol luci-app-ksmbd luci-i18n-ksmbd-zh-cn ksmbd-utils kmod-usb3
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 116736k
...
define Device/olb_hw3000
  DEVICE_VENDOR := OLB
  DEVICE_MODEL := HW3000
  DEVICE_DTS := mt7981-olb-hw3000
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := olb,hw3000
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 114688k
